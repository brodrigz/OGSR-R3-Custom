           ...
           class_<key_binding_registrator>("DIK_keys")
               .enum_("dik_keys")
                   [(value("DIK_ESCAPE", int(DIK_ESCAPE)), value("DIK_2", int(DIK_2)), value("DIK_4", int(DIK_4)), value("DIK_6", int(DIK_6)), value("DIK_8", int(DIK_8)),
                    ...
                    value("MOUSE_6", int(MOUSE_6)), value("MOUSE_7", int(MOUSE_7)), value("MOUSE_8", int(MOUSE_8)), value("MOUSE_WHEEL_UP", int(MOUSE_WHEEL_UP)),
                    value("MOUSE_WHEEL_DOWN", int(MOUSE_WHEEL_DOWN)))])];
}
